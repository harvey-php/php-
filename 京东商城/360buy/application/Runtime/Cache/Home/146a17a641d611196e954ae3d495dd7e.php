      ...
      <div id="globalLeft">
        <div class="globalModule">
          ...
          <div id="global_box" class="userMenu">
			...
			<a href="/360buy/index.php/User/tag" class="curs"><img src="/360buy/public/themes/jindong/images/u7.gif"> 我的标签</a>
      ...
      <div id="globalBigRight">
        <div class="tab_box">
          <div id="globalUserCenterTags" class="globalModule">
            <div class="tab_title"><h3>我的标签</h3></div>
            <div class="globalModuleContent">
              <a href="/360buy/index.php/Search/index" style="color:#666666;font-size:0.8em;">CD机</a>
              <a href="#" onclick="if (!confirm('您确认要删除此标签吗？')) return false;" title="删除" class="textDel">
                <img src="/360buy/public/themes/jindong/images/drop.gif" alt="删除" />
              </a>
              <a href="/360buy/index.php/Search/index" style="color:#666666;font-size:0.8em;">家里用</a>
              <a href="#" onclick="if (!confirm('您确认要删除此标签吗？')) return false;" title="删除" class="textDel">
                <img src="/360buy/public/themes/jindong/images/drop.gif" alt="删除" />
              </a>
            </div>
