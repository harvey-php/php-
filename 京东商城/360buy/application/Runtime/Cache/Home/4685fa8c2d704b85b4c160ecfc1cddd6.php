...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div id="globalLeft">
        <div class="globalModule">
          ...
          <div id="global_box" class="userMenu">
			...
			<a href="/360buy/index.php/User/collection" class="curs"><img src="/360buy/public/themes/jindong/images/u5.gif"> 我的收藏</a>
      ...
      <div id="globalBigRight">
        <div class="tab_box">
          <div class="globalModule">
            <div class="tab_title"><h3>收藏商品</h3></div>
            <div class="globalModuleContent">
              <table cellspacing="0" class="tableList">
                ...
                <tr>
                  <td>
                    <a href="/360buy/index.php/Goods/index">松下（Panasonic）NI-S100TS 蒸汽电熨斗 1200w</a>
                  </td>
                  <td>美智价：<span class="goodsPrice">￥89元</span></td>
                  <td>
                    <span class="btnBlue"><a href="javascript:if (confirm('确定将此商品加入关注列表么？'))">关注</a></span>
                    <span class="btnBlue"><a href="#">加入购物车</a></span> <span class="btnBlue"><a href="javascript:if (confirm('您确定要从收藏夹中删除选定的商品吗？'))">删除</a></span>
                  </td>
                </tr>
                <tr>
                  <td>
          ...
          <div class="globalModule">
            <div class="tab_title"><h3>我要推荐</h3></div>
            <div class="globalModuleContent">
              <form name="theForm" method="post" action="">
                <table cellspacing="0" class="tableList">
                  <tr>
                    <th width="120">是否显示商品图片：</th>
                    <td>
                  ...
                  <tr>
                    <td colspan="2" align="center"><input type="button" name="gen_code" value="生成代码" onclick="genCode()" />        </td>
                  </tr>
                  <tr>
