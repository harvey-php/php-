...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div id="globalLeft">
        <div class="globalModule">
          ...
          <div id="global_box" class="userMenu">
			...
			<a href="/360buy/index.php/User/trackpackages" class="curs"><img src="/360buy/public/themes/jindong/images/u12.gif"> 跟踪包裹</a>
	  ...
	  <div class="tab_box">
	    <div class="globalModule">
	      <div class="tab_title"><h3>跟踪包裹</h3></div>
	      <div class="globalModuleContent">
	        <table cellspacing="0" id="order_table" class="tableList">
	          <tr>
	            <th>订单号</th>
	            <th>操作</th>
	          </tr>
