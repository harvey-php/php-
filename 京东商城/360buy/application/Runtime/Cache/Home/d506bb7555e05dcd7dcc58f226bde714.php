...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div style="width:80%; margin:0 AUTO">
        <div class="flow_tou">
          <img  style="float:left"src="/360buy/public/themes/jindong/images/cart_001.gif" />
        ...
        <div class="flowBox">
          <form id="formCart" name="formCart" method="post" action="/360buy/index.php/Cart/update">
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
              ...
              <tr>
                <td bgcolor="#ffffff" align="left">
                  <a href="/360buy/index.php/Goods/index" target="_blank"><img src="/360buy/public/images/201003/thumb_img/4759_thumb_G_1268730511818.jpg" border="0" title="完美搭配之夏秋装韩版磨破火辣牛仔小短裤" /></a><br />
                  <a href="/360buy/index.php/Goods/index" target="_blank" class="f6">完美搭配之夏秋装韩版磨破火辣牛仔小短裤</a>
                </td>
                <td bgcolor="#ffffff"></td>
                <td align="center" bgcolor="#ffffff">￥30.00元</td>
                <td align="center" bgcolor="#ffffff">
                  <input type="text" name="goods_number[42]" id="goods_number_42" value="1" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>
                </td>
                <td align="center" bgcolor="#ffffff">￥30.00元</td>
                <td align="center" bgcolor="#ffffff">
              ...
              <tr>
                <td colspan="7" align="right" bgcolor="#ebf4fb" style="color:#F00; font-weight:bold">购物金额小计 ￥11111141.00元</td>
              </tr>
            </table>
            ...
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#aacded">
              <tr>
                <td bgcolor="#ffffff" style="padding:20px;0">
                  <a href="/360buy/index.php/Index/index"><img style="vertical-align:middle;" src="/360buy/public/themes/jindong/images/jixubuy.gif" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
                  <input style="vertical-align:middle;"  type="button" value="" class="clear_car" />&nbsp;&nbsp;&nbsp;&nbsp;
                  <input style="vertical-align:middle;" name="submit" type="submit" class="gengxin_car" value="" />
                </td>
                <td bgcolor="#ffffff" align="right" style="padding:20px;0"><a href="/360buy/index.php/Cart/flow"><img src="/360buy/public/themes/jindong/images/checkout.gif" alt="checkout" /></a></td>
              </tr>
            </table>
          </form>
        </div>
