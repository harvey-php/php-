...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div id="globalLeft">
        <div class="globalModule">
          ...
          <div id="global_box" class="userMenu">
			...
			<a href="/360buy/index.php/User/accountlog" class="curs"><img src="/360buy/public/themes/jindong/images/u13.gif"> 资金管理</a>
      ...
      <div id="globalBigRight">
        <div class="tab_box">
          <div class="globalModule">
            <div class="tab_title"><h3>会员余额</h3></div>
            <div class="globalModuleContent">
              <table cellspacing="0" class="tableList">
                <tr>
                  <td align="right">
                    <a href="/360buy/index.php/User/accountdeposit">充值</a> | 
                    <a href="/360buy/index.php/User/accountraply">提现</a> | 
                    <a href="/360buy/index.php/User/accountdetail">查看帐户明细</a> | 
                    <a href="/360buy/index.php/User/accountlist">查看申请记录</a>
                  </td>
                </tr>
              </table>
              <table cellspacing="0" class="tableList">
                ...
                <tr>
                  <td colspan="7" align="right">您当前的可用资金为：￥0.00元</td>
                </tr>
              </table>
              <div class="blank"></div>
