...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div id="globalLeft">
        <div class="globalModule">
          ...
          <div id="global_box" class="userMenu">
			...
			<a href="/360buy/index.php/User/booking" class="curs"><img src="/360buy/public/themes/jindong/images/u8.gif"> 缺货登记</a>
      ...
      <div id="globalBigRight">
        <div class="tab_box">
          <div class="globalModule">
            <div class="tab_title"><h3>缺货登记</h3></div>
            <div class="globalModuleContent">
              <table cellspacing="0" class="tableList">
                <tr>
                  <th width="220">订购商品名</th>
                  <th width="80">订购数量</th>
                  <th width="80">登记时间</th>
                  <th width="180">处理备注</th>
                  <th width="80">操作</th>
                </tr>
                <tr>
                  <td><a href="/360buy/index.php/Goods/index" target="_blank">华为（HUAWEI）C8600 经典机器 直降70元！超值特价！</a></td>
                  <td>1</td>
                  <td>2012-05-30</td>
                  <td>N/A</td>
                  <td><span class="btnBlue"><a href="javascript:if (confirm('您确定要删除此条记录吗？')) ">删除</a></span></td>
                </tr>
                <tr>
                  <td><a href="/360buy/index.php/Goods/index" target="_blank">华为（HUAWEI）C8600 经典机器 直降70元！超值特价！</a></td>
                  <td>1</td>
