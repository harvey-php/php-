      ...
      <div id="globalBigRight">
        <div id="globalUserCenterInfo" class="globalModule">
          <div class="globalModuleContent">
            <h2>hello 欢迎您回到 京东网上商城！</h2>
            <p class="textDesc">您的上一次登录时间：2012-05-30 09:45:49</p>
            <p class="textDesc">您的等级是 注册用户 </p>
            <p class="textStrong">您还没有通过邮件认证 <a href="javascript:sendHashMail()">点此发送认证邮件</a></p>
            <div class="msgNocice">用户中心公告！</div>
            <div class="f_l" style="width:350px; float:left">
              <h5 class="h5"><span>您的账户</span></h5>
              <div class="blank"></div>
              &nbsp;余额:<a href="/360buy/index.php/User/accountlog" style="color:#006bd0;">￥0.00元</a><br />
              &nbsp;红包:<a href="/360buy/index.php/User/bonus" style="color:#006bd0;">共计 0 个,价值 ￥0.00元</a><br />
              &nbsp;积分:0积分<br />
            </div>
            <div class="f_r" style="width:350px; float:right">
              <h5 class="h5"><span>用户提醒</span></h5>
              <div class="blank"></div>您最近30天内提交了1个订单<br />
            </div>
          </div>
        </div>
