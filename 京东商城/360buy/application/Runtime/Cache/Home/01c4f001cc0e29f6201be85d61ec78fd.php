...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div id="globalLeft">
        <div class="globalModule">
          ...
          <div id="global_box" class="userMenu">
			...
			<a href="/360buy/index.php/User/order" class="curs"><img src="/360buy/public/themes/jindong/images/u3.gif"> 我的订单</a>
      ...
      <div id="globalBigRight">
        <div class="tab_box">
          <div class="globalModule">
            <div class="tab_title"><h3>我的订单</h3></div>
            <div class="globalModuleContent">
              <table cellspacing="0" class="tableList">
                ...
                <tr>
                  <td><a href="/360buy/index.php/User/orderdetails">2012053041113</a></td>
                  <td>2012-05-30 11:09:25</td>
                  <td>￥11111116.00元</td>
                  <td>未确认,未付款,未发货</td>
                  <td><a href="/360buy/index.php/User/cancleorder" onclick="if (!confirm('您确认要取消该订单吗？取消后此订单将视为无效订单')) return false;">取消订单</a></td>
                </tr>
                <tr>
                  <td><a href="/360buy/index.php/User/orderdetails">2012053041113</a></td>
                  <td>2012-05-30 11:09:25</td>
              ...
              <div class="blank"></div>
              <form name="selectPageForm" action="/shop/user.php" method="get">
                <div id="pager"></div>
              </form>
            </div>
          </div>
          <div class="globalModule">
            <div class="tab_title"><h3>合并订单</h3></div>
            <div class="globalModuleContent">
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="to_order">
                        ...
                        <option value="2012053041113">2012053041113</option>
                      </select>
                    </td>
                    <td>从订单：</td>
                    <td>
