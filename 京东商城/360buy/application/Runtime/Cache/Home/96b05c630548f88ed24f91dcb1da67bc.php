...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div id="globalLeft">
        <div class="globalModule">
          ...
          <div id="global_box" class="userMenu">
			...
			<a href="/360buy/index.php/User/comment" class="curs"><img src="/360buy/public/themes/jindong/images/u11.gif"> 我的评论</a>
      ...
      <div id="globalBigRight">
        <div class="tab_box">
          <div class="globalModule">
            <div class="tab_title"><h3>我的评论</h3></div>
            <div class="globalModuleContent">
              <table cellspacing="0" class="tableList">
                <tr>
                  <th width="580">商品评论：华为（HUAWEI）C8600 经典机器 直降70元！超值特价！<span class="textTime">2012-05-30 16:41:02</span></th>
                  <th><span class="btnBlue"><a href="#" onclick="if (!confirm('你确实要彻底删除这条留言吗？')) return false;">删除</a></span></th>
                </tr>
                <tr>
                  <td colspan="2">这是什么手机</td>
                </tr>
              </table>
              <table cellspacing="0" class="tableList">
                <tr>
