...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="/360buy/public/js/global.js"></script>
    <script type="text/javascript" src="/360buy/public/js/compare.js"></script>
    ...
    <style type="text/css">
	<!--
	.age_box a{float: left; height:22px; line-height:22px; width:70px; background:url(/360buy/public/themes/jindong/images/biao6.gif) 0 center no-repeat; padding-left:10px;font-family:Arial, Helvetica, sans-serif;color:#333333}
	-->
	</style>
    ...
    else
    {
          ...
          <div id="global_box">
            <ul>
              <li style=" overflow:hidden;">
                ...
                <div class="top_one">
                  <a style="color:#FFF" href="/360buy/index.php/Goods/index" title=""><img style=" width:50px; height:38px;" src="/360buy/public/images/201001/thumb_img/4753_thumb_G_1264530751217.jpg" alt="" class="samllimg" /> </a>
                  <a style="float:left" href="/360buy/index.php/Goods/index" title="">贝尔莱德 蒸汽挂烫机GS18-DJ/H ... 
              ...
              <li style=" overflow:hidden;">
                ...
                <a href="/360buy/index.php/Goods/index" title="">多普达(Dopod) S505 CDMA...</a>
              </li>
              <li style=" overflow:hidden;">
      ...
      <div id="globalBigRight">
        <div id="globalGoodsList" class="globalModule">
          <div class="globalGoodsListMenu">
            <form action="" method="post" class="sort" name="listform">
              ...
              <span style="float: right; margin-top:-26px;" >
                <span class="globalGoodsListMenuDisplay">显示方式：  <a href="javascript:;" onclick="javascript:display_mode('list')"><img src="/360buy/public/themes/jindong/images/btn_display_mode_list.gif" alt="" /></a> <a href="javascript:;" onClick="javascript:display_mode('grid')"><img src="/360buy/public/themes/jindong/images/btn_display_mode_grid_act.gif" alt="" /></a></span>
                <select name="sort">
                ...
                <input type="image" name="imageField" src="/360buy/public/themes/jindong/images/btn_submit.gif" />
          ...
          <div class="itemGrid">
            <div class="item">
              <p class="pic"><a href="/360buy/index.php/Goods/index"><img src="/360buy/public/images/201001/thumb_img/4730_thumb_G_1262451940947.jpg" alt="惠普（HP）DX2355MT WE572..." /></a></p>
              <p class="name" style="height:36px; overflow:hidden; margin:0 15px;">
                <a href="/360buy/index.php/Goods/index" title="">惠普（HP）DX2355MT WE572...<span>三年上门服务 主流配置 HP品质</span></a>
              </p>
              <p class="price">
              ...
              <p class="btnList">
                <a href="javascript:collect(4730)"><img src="/360buy/public/themes/jindong/images/buttons_coll.gif"></a> <a href="javascript:addToCart(4730)"><img src="/360buy/public/themes/jindong/images/buttons_buy.gif"></a> <a href="javascript:;" onClick="Compare.add(4730,'惠普（HP）DX2355MT WE572...')"><img src="/360buy/public/themes/jindong/images/buttons_comp.gif"></a>
              </p>
            </div>
            <div class="item">
              <p class="pic"><a href="/360buy/index.php/Goods/index"><img src="/360buy/public/images/201001/thumb_img/4730_thumb_G_1262451940947.jpg" alt="惠普（HP）DX2355MT WE572..." /></a></p>
