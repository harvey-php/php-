...
function showtime(obj)
{
  ...
  if (dateLeft > 0)
  {
    Temp = "<strong> " + dateLeft  +"</strong>"  + _day + "<strong> " + hourZero + hourLeft + "</strong>" + _hour + "<strong>" + minuteZero + minuteLeft +"</strong>" + _minute + "<strong>" + secondZero + secondLeft + "</strong>" + _second;
  }
  else
  {
    if (hourLeft > 0)
